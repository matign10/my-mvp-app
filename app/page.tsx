...
// import SimpleClientLogger from "@/components/SimpleClientLogger"; // Eliminar logger
  ...
  return (
    <main>
      ...
      <section className="relative h-screen bg-transparent z-0">
        <BackgroundVideo />
        {/* <SimpleClientLogger message="Logger in Hero Section" /> */}
        <div className="relative h-full flex flex-col justify-center z-10 pt-16 pb-10 max-w-screen-xl mx-auto px-4">
          <div className="max-w-2xl text-white">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 tracking-tight drop-shadow-2xl text-white">
      ...
      {/* Áreas de Práctica */}
      <section className="relative z-10 py-16 md:py-20 bg-white dark:bg-gray-800" id="areas">
        <div className="max-w-screen-xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#2d3436] dark:text-white mb-12 text-center tracking-tight">
            Áreas de Práctica
          </h2>
      ...
      {/* Abogados Destacados */}
      <section className="relative z-10 py-16 md:py-20 bg-[#f8f9fa] dark:bg-gray-900" id="profesionales">
        <div className="max-w-screen-xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#2d3436] dark:text-white mb-12 text-center tracking-tight">
            Nuestros Abogados
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                role: "Socio",
                description: "Especialista en Derecho Penal. Trabajó durante 6 años en el Poder Judicial de la Ciudad Autónoma de Buenos Aires. Es miembro en la materia Elementos de Derecho Penal de la Universidad de Buenos Aires.",
              ...
              <div key={i} className="text-center">
                <div className="relative w-32 h-32 md:w-48 md:h-48 mx-auto mb-4 bg-gray-200">
                  {profesional.name === "Matías González Novillo" ? (
                    <Image
                      src="/abogados/matias-gonzalez-novillo.jpg"
                      alt={`Foto de ${profesional.name}`}
                      width={192}
                      height={192}
      ...
      {/* Sobre Nosotros */}
      <section className="relative z-10 py-16 md:py-20 bg-white dark:bg-gray-800" id="sobre-nosotros">
        <div className="max-w-screen-xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#2d3436] dark:text-white mb-12 text-center tracking-tight">
            Sobre Nosotros
          </h2>
      ...
      {/* Contacto */}
      <section className="relative z-10 py-16 md:py-20 bg-white dark:bg-gray-800" id="contacto">
        <div className="max-w-screen-xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#2d3436] dark:text-white mb-12 text-center tracking-tight">
            Contacto
          </h2>
              ...
              <div>
                ...
                <div className="space-y-4 text-[#636e72]">
                  <p className="flex items-center">
                    ...
                    Uruguay 763, piso 5°, CABA, Argentina
                  </p>
                  <p className="flex items-center">
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    estudioecen@gmail.com
                  </p>
                </div>
              </div>
              <div>
